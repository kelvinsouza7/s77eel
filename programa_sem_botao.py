...
print("Escolha um perfil fornecido pelo programa ou informe os dados de um novo perfil:")
print("(1) Perfil W 150 x 13.0")
print("(2) Perfil W 250 x 17.9")
print("(3) Perfil W 310 x 21.0")
print("(4) Novo Perfil")
...
print()
print("Digite as informações da viga em Aço")
print("Utilize o ponto para as casas decimais")
print("Digite os pesos atuantes na viga:")
pesop = pp/100
larg = largura/1000
